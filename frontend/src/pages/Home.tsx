      ...
      <section className="px-5 -mt-12">
        <div className="max-w-4xl mx-auto">
          <Photo
            ...
            alt="IntelliFrost dashboard: koelcel-detail met live temperatuurgrafiek"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
            <div className="rounded-2xl border-2 border-gray-200 p-6">
              ...
              <p className="text-xs text-gray-400">+ hardware op offerte</p>
            </div>
            <div className="rounded-2xl border-2 border-brand bg-navy text-white p-6">
              ...
              <p className="text-xs text-white/40">+ hardware op offerte</p>
            </div>
          </div>
