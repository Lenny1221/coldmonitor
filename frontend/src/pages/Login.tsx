...
const Login: React.FC = () => {
  ...
  const errorMsg = errorParam === 'invalid_or_expired_token' ? 'De verificatielink is ongeldig of verlopen.' : errorParam === 'missing_token' ? 'Geen verificatietoken gevonden.' : errorParam === 'google_not_configured' ? 'Google-inloggen is niet geconfigureerd.' : errorParam === 'oauth_failed' ? 'OAuth-inloggen mislukt. Probeer opnieuw.' : errorParam === 'email_not_verified' ? 'Bevestig eerst je e-mailadres via de link in je inbox.' : null;
