...
const AppPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>De IntelliFrost-app – Uw koelcellen in uw broekzak</title>
        <meta name="description" content="De IntelliFrost-app voor de eindklant: push-meldingen bij alarm, live temperatuur per koelcel en alarmen bevestigen met één tik. Beschikbaar in de App Store." />
        <meta name="keywords" content="IntelliFrost app, koelcel app, temperatuur app, alarm push notificatie koelcel, App Store koelcelmonitoring" />
        <link rel="canonical" href="https://intellifrost.be/app" />
        <meta property="og:title" content="De IntelliFrost-app voor de eindklant" />
        <meta property="og:description" content="Push-meldingen, live temperatuur en alarmen bevestigen met één tik. Beschikbaar in de App Store." />
        <meta property="og:url" content="https://intellifrost.be/app" />
      </Helmet>

      {/* Hero */}
      <section className="bg-navy text-white px-5 pt-28 pb-20 overflow-hidden">
