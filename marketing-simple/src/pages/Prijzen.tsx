      ...
      <div className="max-w-5xl mx-auto px-5">
        ...
        <div className="grid md:grid-cols-3 gap-5 items-start mb-20">
          ...
          <div className="rounded-3xl border-2 border-gray-200 p-7 flex flex-col">
            ...
            <a href="/contact" className="mt-6 block text-center py-3 rounded-xl border-2 border-brand text-brand font-semibold text-sm hover:bg-brand/10">
              Aan de slag
            </a>
          </div>
          ...
          <div className="relative rounded-3xl border-2 border-brand bg-navy text-white p-7 flex flex-col shadow-xl shadow-brand/20 md:-mt-3">
            ...
            <a href="/contact" className="mt-6 block text-center py-3 rounded-xl bg-brand text-navy font-bold text-sm hover:bg-brand-dark">
              Demo aanvragen
            </a>
          </div>
          ...
          <div className="rounded-3xl border-2 border-gray-200 p-7 flex flex-col">
            ...
            <a href="/contact" className="mt-6 block text-center py-3 rounded-xl border-2 border-gray-300 text-gray-700 font-semibold text-sm hover:border-brand hover:text-brand">
              Offerte vragen
            </a>
          </div>
        </div>
