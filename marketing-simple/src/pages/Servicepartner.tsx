...
export default function Servicepartner() {
  const [active] = useState<Tier>('comfort');

  return (
    <>
      {/* Hero */}
      <section className="bg-navy text-white px-5 pt-16 pb-16">
      ...
      <div className="max-w-4xl mx-auto px-5">
        ...
        <section className="mb-16">
          <div className="rounded-3xl bg-navy text-white p-8 sm:p-10">
            ...
            <a href="/contact" className="inline-block bg-brand text-navy font-bold px-7 py-3 rounded-xl hover:bg-brand-dark transition-colors">
              Combodeal aanvragen
            </a>
          </div>
        </section>
