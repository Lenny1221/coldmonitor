...
export const CONTROLLER_TYPES: ControllerType[] = [
  ...
  },
  {
    id: 'DIXELL_XR110C',
    name: 'Dixell XR110C',
    description: 'Dixell XR110C via Modbus RTU (zelfde register-set als XR60/XR70)',
    protocol: 'MODBUS_RTU',
    defaultBaudRate: 9600,
    defaultSlaveAddr: 1,
    commands: [
      { id: 'READ_TEMPERATURE', name: 'Temperatuur lezen', description: 'Lees actuele cel-temperatuur (NTC1)', category: 'READ', hasInput: false },
      { id: 'READ_SETPOINT', name: 'Setpoint lezen', description: 'Lees ingestelde temperatuur (Set)', category: 'READ', hasInput: false },
      { id: 'READ_ALARM_STATUS', name: 'Alarmstatus lezen', description: 'Lees actieve alarmen', category: 'READ', hasInput: false },
      { id: 'SET_SETPOINT', name: 'Setpoint instellen', description: 'Stel cel-setpoint in (°C). XR110C: range -50..+50.', category: 'SET', hasInput: true, min: -50, max: 50, step: 0.5, unit: '°C', requiresConfirmation: true },
      { id: 'ALARM_RESET', name: 'Alarm resetten', description: 'Reset actieve alarmen', category: 'ACTION', hasInput: false, requiresConfirmation: true },
      { id: 'DEFROST_START', name: 'Defrost starten', description: 'Start handmatige ontdooiing (coil 0x0001)', category: 'ACTION', hasInput: false, requiresConfirmation: true },
      { id: 'DEFROST_STOP', name: 'Defrost stoppen', description: 'Stop handmatige ontdooiing', category: 'ACTION', hasInput: false, requiresConfirmation: true },
      { id: 'SET_DEFROST_INTERVAL', name: 'Defrost interval', description: 'Interval tussen ontdooiingen (parameter idF, uur)', category: 'SET', hasInput: true, min: 0, max: 199, step: 1, unit: 'uur', requiresConfirmation: true },
      { id: 'SET_DEFROST_DURATION', name: 'Defrost duur', description: 'Maximale ontdooi-duur (parameter MdF, min)', category: 'SET', hasInput: true, min: 1, max: 199, step: 1, unit: 'min', requiresConfirmation: true },
    ],
  },
  {
    id: 'ELIWELL_IC900',
